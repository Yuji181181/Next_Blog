    ...
    <div className="min-h-screen py-8 px-4 md:px-12">
        ...
        <form className="bg-slate-200 p-6 rounded-lg shadow-lg">
            <div className="mb-4">
                ...
                <input type="text" className="shadow border rounded w-full py-2 text-gray-700 leading-tight focus:outline-none" />
            </div>
            <div className="mb-4">
            ...
            <div className="mb-4">
                ...
                <textarea className="shadow border rounded w-full py-2 text-gray-700 leading-tight focus:outline-none" />
            </div>
